...
T1brain=$inDir/anat/T1_MNI_brain.nii.gz
T1=$inDir/anat/T1_MNI.nii.gz
rsMean=$inDir/func/mcImgMean.nii.gz
rsMask=$inDir/func/mcImgMean_mask.nii.gz
epiDataFilt=$inDir/func/preproc.feat/filtered_func_data.nii.gz
