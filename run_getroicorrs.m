...
fid1=fopen('/home/brain/Labs/12-Lab/sublist.txt');
...
fid2=fopen('/home/brain/Labs/12-Lab/ROIs/roilist.txt');   %ROI LIST HERE
...
fid = fopen('subject_roi-pair_corr.txt','w');
fprintf(fid, '%s \n', pair);
fclose(fid);
...
for row=1:N
    fid = fopen('subject_roi-pair_corr.txt','a');
    clear a;
